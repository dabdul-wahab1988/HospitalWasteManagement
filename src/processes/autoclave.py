...
class AutoclaveProcess(TreatmentProcess):
    ...
    The calculation uses the following steps:
      ...
      5. Calculate mercury (Hg) emissions based on the fraction of mercury present in the heavy metals waste.
    ...
    def calculate_direct_emissions(self, waste, scenario: dict = None) -> dict:
        ...
        # Calculate total organic fraction from relevant components:
        # - From general waste: non_hazardous
        # - From infectious waste: body_fluids and lab_cultures
        total_organic = (
        ...
        emissions = {
            ...
            "hg": mass * waste.composition.get("heavy_metals_waste", {}).get("mercury_waste", 0) * f["hg_leach_factor"] * ureg("kg"),
        }
